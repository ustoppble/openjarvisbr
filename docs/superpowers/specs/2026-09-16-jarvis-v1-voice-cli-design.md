# Jarvis v1 — assistente de voz em Rust (degrau 1: só conversa)
...
Um binário Rust, `jarvis`, que roda no terminal do Mac (e futuramente Windows),
...
4. `session` recebe:
   ...
   - transcrições → imprime no terminal (você em uma cor, Jarvis em outra)
...
- Interromper o Jarvis falando por cima e ele parar de falar.
